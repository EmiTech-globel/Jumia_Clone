  ...
  return (
    ...
    min-h-screen bg-gray-50 p-4">
        ...
        shadow-lg w-full max-w-4xl">
            <h1 className="text-4xl font-bold text text-gray-900
            tracking-tight mb-8">
                My Orders
            </h1>
                            ...
                            sm:items-center">
                                ...
                                <div className="sm:text-right">
                                    ...
                                    <p className="font-bold text-lg">
                                        {formatCurrency(order.totalPrice ?? 0, order.currency ?? "NGN")}
                                    </p>
                                </div>
                            </div>

                            {order.amountDiscount ? (
                                <div className="mt-4 p3 sm:p-4 bg-red-50 rounded-lg">
                                    <p className="text-red-600 font-medium mb-1 txt-sm sm:text-base">
                                        Discount Applied:{" "}
                                        {formatCurrency(order.amountDiscount, order.currency ?? "NGN")}
                                    </p>
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {order.products?.map((product) => (
                                    <div 
                                     ...
                                     gap-3 py-2 border-b last:border-b-8"
                                    >
